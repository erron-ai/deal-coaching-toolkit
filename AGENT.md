...
## Objective
Maintain `deal-coaching-toolkit` as a reliable, useful, and test-first project aligned with its primary promise:
> Call transcript analysis with objection detection and next-best-action suggestions.
